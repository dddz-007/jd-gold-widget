...
无需安装 Python。打开 [Releases](https://github.com/dddz-007/jd-gold-widget/releases/latest)，下载后直接运行：
...
推送形如 `v0.1.0` 的 tag 后，GitHub Actions 会自动打包并发布到 Releases。手动发版说明见 [docs/releasing.md](docs/releasing.md)。
